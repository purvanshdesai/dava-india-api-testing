...
import { UserInvitationsService, getOptions } from '../user-invitations.class'
import { userInvitationsPath, userInvitationsMethods } from '../user-invitations.shared'

export * from '../user-invitations.class'
export * from '../user-invitations.schema'

// A configure function that registers the service and its hooks via `app.configure`
export const superAdminInvitations = (app: Application) => {
  // Register our service on the Feathers application
  app.use(userInvitationsPath, new UserInvitationsService(getOptions(app)), {
