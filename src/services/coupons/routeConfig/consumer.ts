...
import { ApplyCouponService, ConsumerCouponsService, getOptions } from '../coupons.class'
import {
...
import { ConsumerCouponPath } from '../coupons.shared'

export default function ConsumerCoupon(app: Application) {
  // Register our service on the Feathers application
  app.use(ConsumerCouponPath, new ConsumerCouponsService(getOptions(app)), {
  ...
  // Initialize hooks
  app.service(ConsumerCouponPath).hooks({
    around: {
      all: [
        authenticate({
