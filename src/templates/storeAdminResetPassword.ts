  ...
  <body>
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        <div class="welcome">
            <div style="font-size: 20px; font-weight: 500;">Set Up Your Password</div>
        </div>

        <p>Dear User</p>
        <p>Welcome to DavaIndia, your trusted destination for affordable medicines!</p>
        <br/>
        <p>To reset your password, please <strong>set your password by clicking the link below</strong></p>
        ...
        <p>Best regards,<br>The DavaIndia Team</p>
      </div>
